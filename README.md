...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/intermol-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11024&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/intermol-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `intermol` can be installed with:

```
conda install intermol
```

It is possible to list all of the versions of `intermol` available on your platform with:
